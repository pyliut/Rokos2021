# -*- coding: utf-8 -*-
"""
Created on Mon Jul 12 13:26:20 2021
...
def goodness_of_fit(t_obs, n_iter = 100, model = stats.norm):
    """
    Finds KS statistic & p_value, MAE, MSE of t_obs against a proposed distribution
    Also plots the fitted distribution against the observed data (t_obs)
    ...
    print("KS statistic:",D_mean , "    p-val:", p_mean )
    print("MAE (s):", mae_mean, "MSE (s):", mse_mean)
    
    #5) plot predicted vs actual data
    plt.hist(t_obs, density = True, bins = 50, alpha = 0.5);
