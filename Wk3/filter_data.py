...
def filter_data(df):
    ...
    #3) remove every column except: origin, target, edge_id, is_final, operation_time, _meta
    df = df.loc[:,["origin", "target", "edge_id", "is_final", "operation_time", "_meta"]]
    ...
    df = df.loc[:,["origin", "target", "edge_id", "is_final", "operation_time", "start", "finish"]]
