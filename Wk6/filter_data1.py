...
def filter_data1(df):
    ...
    df = df.loc[:,["origin", "target", "run_id","agent", "edge_id", "is_final", "operation_time", "_meta"]]
    ...
    df = df.loc[:,["origin", "target", "edge_id", "is_final", "operation_time", "start", "finish", "run_id","agent"]]
