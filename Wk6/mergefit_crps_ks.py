# -*- coding: utf-8 -*-
"""
Created on Thu Aug  5 11:48:01 2021
...
def mergefit_crps_ks(df, edge_list, n_samples = 10):
    ...
    for i in range(len(edge_list)):
        ...
        mergefit_stats["crps"][i] = crps["crps"].median()
        ...
        mergefit_stats["crps_orig"][i] = crps_orig["crps"].median()       
