# -*- coding: utf-8 -*-
"""
Created on Tue Aug 17 16:49:26 2021
...
def distances_cvm(df, metric = "operation_time"):
    """
    Returns difference matrix between edges and a list of the edge names
    Difference metric is Cramer Von Mises (2 sample) test
    ...
    for i in range(n_edge):
        ...
        for j in range(n_edge):
            ...
            #calculate cvm statistic & p-value between edges
            cvm = sp.stats.cramervonmises_2samp(t_op1,t_op2)
            
            diff_list.append(cvm.statistic)
