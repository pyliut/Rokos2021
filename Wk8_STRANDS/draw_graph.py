...
def draw_graph(filename = "walmart_map.yaml", print_labels = False, same_scale = True, size = 3, rotate = False):
    """
    ...
    nx.draw_networkx_nodes(G, nx.get_node_attributes(G, 'pos'), 
            with_labels=True, node_color = colors,edge_color = "steelblue", 
            node_size = 50, font_size = 5,
           ax = ax)
    ...
    plt.savefig("recent_map.png", dpi = 1000, bbox_inches = "tight")
    return G