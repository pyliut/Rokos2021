# -*- coding: utf-8 -*-
"""
Created on Fri Jul  9 15:22:05 2021
...
def edge_plot_lognormal(df, count, n_rows = 3, n_cols = 3):
    """
    Plots the data for the n_rows*n_cols edges with the most samples
    Fits a lognormal curve to each sample
    ...
    for i in range(n_rows):
        for j in range(n_cols):
            ...
            p_test = Lognormal(t_test,mu, sigma**2, loc)
