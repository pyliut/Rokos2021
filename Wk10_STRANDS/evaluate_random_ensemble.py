# -*- coding: utf-8 -*-
"""
Created on Wed Sep  1 16:48:18 2021
...
def evaluate_random_ensemble(edge,df_test, df_train, filename_train = "tsc_map.yaml",
    ...
    #initial run
    mean_test, var_test, prior, t_op_prior, edge_prior = random_prior(df_train,filename = filename_train,
                                             metric = metric, cutoff=cutoff, max_obs = max_obs, 
