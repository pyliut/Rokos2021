# -*- coding: utf-8 -*-
"""
Created on Tue Aug 31 16:00:10 2021
...
def Normal_Gamma_bayes_updateone(mean_test, var_test, posterior, t_obs, threshold = 0.9, plot_graph = False):
    """
    ...
    likelihood = Gaussian_broadcast(t_obs,mean_test,var_test)
    #Bayes rule
