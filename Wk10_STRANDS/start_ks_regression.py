# -*- coding: utf-8 -*-
"""
Created on Sat Sep 11 22:51:18 2021
...
def start_ks_regression(df_train, df_test, clf,
    ...
    for i, edge_test in enumerate(edge_list):
        ...
        if len(subset_train) >= cutoff:
            ...
            edge_train = similar_regression_fast(edge = edge_test, df_train = df_train, clf = clf, 
