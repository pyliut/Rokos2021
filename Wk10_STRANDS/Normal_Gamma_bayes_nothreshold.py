# -*- coding: utf-8 -*-
"""
Created on Wed Sep  1 11:56:46 2021
...
def Normal_Gamma_bayes_nothreshold(t_obs, mu_0 = 10, beta = 5, a = 1, b = 2, 
                                   max_range = 10, plot_graph = True):
    """
    ...
    max_range: FLOAT, scalar
        Maximum test mean & variance. The default is 10.
    ...
    mean_start= 0.01
    mean_stop = max_range   #round up to nearest 5 secs
    mean_step = 0.01
    mean_test = np.arange(mean_start,mean_stop,mean_step)
    
    #1b) define a range of variances to test
    var_start= 0.01
    var_stop = max_range   #round up to nearest 5 secs
    var_step = 0.01
