# -*- coding: utf-8 -*-
"""
Created on Wed Sep  1 14:33:16 2021
...
def evaluate_bayes_ensemble(edge,df, metric = "difference", 
                            prior_params = [1,0.1,1,1], n_repeats = 5,verbose = False,
                            random_state = None):
    """
    ...
    #initial run
    ks_list, n_list = evaluate_bayes(edge,df, 
                                     metric = metric, prior_params = prior_params, 
                                     verbose = False,
    ...
    for i in range(1,n_repeats):
        ...
        ks_current, n_current = evaluate_bayes(edge,df, 
                                               metric = metric, prior_params = prior_params, 
                                               verbose = False,
    ...
    print("Time taken (evaluate_bayes_ensemble):",toc-tic,"secs")
