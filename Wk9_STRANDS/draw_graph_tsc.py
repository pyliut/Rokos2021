...
def draw_graph_tsc(filename = "tsc_map.yaml", print_labels = False, same_scale = True, size = 3, rotate = False):
    """
    ...
    nx.draw_networkx_nodes(G, nx.get_node_attributes(G, 'pos'), 
            ...
            edge_weight = 0.5, node_size = 50, font_size = 3, font_weight = "bold",
           ax = ax)
