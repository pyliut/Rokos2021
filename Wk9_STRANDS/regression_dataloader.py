# -*- coding: utf-8 -*-
"""
Created on Sun Aug 29 11:08:24 2021
...
def regression_dataloader(df, fit, filename = "aaf_map.yaml",metric = "difference",cutoff = 1, precision = 2, verbose = False, report_interval = 5000):
    """
    ...
    df_ks_diff : pandas df
        ...
        ks_fitted is KS test for 2 lognormally fitted distributions
    ...
    for i in range(n_edges-1):
        ...
        for j in range(i+1,n_edges):
            ...
            df_ks_diff["ks_raw"][index] = ks_raw
            ...
            ks_fitted = np.abs( np.max(cdf1 - cdf2) )
            df_ks_diff["ks_fitted"][index] = ks_fitted
