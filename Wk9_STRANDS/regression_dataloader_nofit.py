# -*- coding: utf-8 -*-
"""
Created on Sun Aug 29 11:14:57 2021
...
def regression_dataloader_nofit(df, filename = "aaf_map.yaml",metric = "difference",cutoff = 1, verbose = False, report_interval = 5000):
    """
