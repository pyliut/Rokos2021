# -*- coding: utf-8 -*-
"""
Created on Wed Aug 25 22:23:57 2021
...
def evaluate_alledge(df,clusters,fit, metric = "difference", n_fitted = 2):
    """
    ...
    for i in range(clusters["cluster_id"].max() + 1):
        ...
        for k in range(len(current_cluster) - 1):
        
            #fit edge with most data
            # Select data of interest
            edge1 = current_cluster["edge_id"][k]
            ...
            #fit other edges
            for j in range(k+1,len(current_cluster)):
